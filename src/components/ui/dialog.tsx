...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-bold leading-none tracking-tight text-amber-400 drop-shadow-[0_0_10px_rgba(251,191,36,0.2)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-cyan-200/60 font-medium", className)}
    {...props}
  />
))
